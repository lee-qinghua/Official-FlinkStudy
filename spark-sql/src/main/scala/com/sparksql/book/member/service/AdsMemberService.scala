...
import com.sparksql.book.member.bean.QueryResult
import com.sparksql.book.member.dao.DwsMemberDao
...
object AdsMemberService {
  /**
    ...
    * @param sparkSession
    */
  def queryDetailApi(sparkSession: SparkSession, dt: String) = { //隐式转换
