package com.sparksql.book.qz.controller

import com.sparksql.book.qz.service.DwsQzService
import com.sparksql.book.util.HiveUtil
...
//    System.setProperty("HADOOP_USER_NAME", "atguigu")
    ...
    DwsQzService.saveDwsUserPaperDetail(sparkSession, dt) //导入用户大宽表
  }
}
